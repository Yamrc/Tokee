...
const ResponseTimeStats: Component<ResponseTimeStatsProps> = (props) => (
	<section class="card-base card-shadow p-5">
		<div class="flex items-center gap-2.5 mb-4">
			<Icon icon="material-symbols:speed" width="1.5rem" height="1.5rem" class="text-(--primary)" aria-hidden="true" />
			<h3 class="text-90 text-lg font-semibold">响应时间</h3>
		</div>
		<div class="grid grid-cols-2 gap-4">
			<div class="p-3 rounded-lg bg-(--btn-regular-bg)">
				<div class="flex items-center gap-1.5 mb-1">
					<Icon icon="material-symbols:avg-time" width="1rem" height="1rem" class="text-75" aria-hidden="true" />
			...
			<div class="p-3 rounded-lg bg-(--btn-regular-bg)">
				<div class="flex items-center gap-1.5 mb-1">
					<Icon icon="material-symbols:trending-down" width="1rem" height="1rem" class="text-75" aria-hidden="true" />
			...
			<div class="p-3 rounded-lg bg-(--btn-regular-bg)">
				<div class="flex items-center gap-1.5 mb-1">
					<Icon icon="material-symbols:trending-up" width="1rem" height="1rem" class="text-75" aria-hidden="true" />
			...
			<div class="p-3 rounded-lg bg-(--btn-regular-bg)">
				<div class="flex items-center gap-1.5 mb-1">
					<Icon icon="material-symbols:summarize" width="1rem" height="1rem" class="text-75" aria-hidden="true" />
